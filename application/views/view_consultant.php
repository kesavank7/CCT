    ...
    <div class="starter-template">
        ...
        <div class="panel panel-info ovrhid">
            <div class="panel-heading">
                <h3 class="panel-title">View Consultant Details</h3>
                        ...
                        <input type="hidden" name="consultant_i_code" value="<?php echo $consultant[0]['ConsultantICode']; ?>">
                            ...
                            <legend>Personal Details:</legend>
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" autocomplete="off" class="form-control" readonly id="consultant_last_name"
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" autocomplete="off" class="form-control" readonly id="consultant_name" name="consultant_name"  value="<?php echo set_value('consultant_name',$consultant[0]['ConsultantName']); ?>" required/>
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" autocomplete="off" class="form-control" readonly id="consultant_email"
                        ...
                        <fieldset style="border: 1px solid gray; padding: 20px;">
                            ...
                            <legend>Address for communication:</legend>
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" autocomplete="off" class="form-control" readonly  id="consultant_pincode"
                        ...
                        <fieldset style="border: 1px solid gray; padding: 20px;">
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select class="form-control" name="consultant_technology" id="consultant_technology" placeholder="Select Primary Skills*" required disabled>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" autocomplete="off" class="form-control" readonly id="consultant_reference"
								  ...
								  <div class="form-group col-md-6">
                                    ...
                                    <input type="text" autocomplete="off" class="form-control" readonly id="HourlyRate"
