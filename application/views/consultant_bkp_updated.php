	...
	<div class="container">
			...
			<div class="container">
				<div class="navbar-header">
					<a class="navbar-brand" href="<?php echo base_url(); ?>">
						<img src="<?php echo base_url(); ?>public/images/logo/logo.png" alt="CG-Vak Logo"
							name="cgvak_logo" class="header_logo" />
					</a>
				</div>
			</div>
		</nav>
		...
		<div class="row">
			<div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
				...
				<?php } else { ?>
					<form action="<?php echo base_url() . 'consultant/register_consultant'; ?>" id="consultant_details"
						method="post" class="form-horizontal" onsubmit="return checkForm(this);"
						enctype="multipart/form-data">
						<h2>Please Register</h2>
						<hr class="colorgraph">
						<div class="tab">
							<h2 class="fs-title">Create your account</h2>
							<p><input type="text" name="consultant_first_name" placeholder="Invoice - First Name*"
									value="<?php echo set_value('consultant_first_name'); ?>"
									oninput="this.className = ''" />
								<?php echo form_error('consultant_first_name', "<small class=' text-danger'>", "</small>"); ?>
							</p>

							<p><input type="text" name="consultant_last_name" placeholder="Invoice - Last Name*"
									value="<?php echo set_value('consultant_last_name'); ?>"
									oninput="this.className = ''" />
								<?php echo form_error('consultant_last_name', "<small class='text-danger'>", "</small>"); ?>
							</p>

							<p><input type="text" name="consultant_name" placeholder="Consultant Name*"
									value="<?php echo set_value('consultant_name'); ?>" oninput="this.className = ''" />
								<?php echo form_error('consultant_name', "<small class='text-danger'>", "</small>"); ?>
							</p>

							<p><input type="text" name="consultant_email" id="consultant_email" placeholder="Email*"
									value="<?php echo set_value('consultant_email'); ?>" oninput="this.className = ''" />
							...
							<p><input type="text" name="consultant_phone_number" placeholder="Phone"
									value="<?php echo set_value('consultant_phone_number'); ?>" />
								<?php echo form_error('consultant_phone_number', "<small class='text-danger'>", "</small>"); ?>
								<small class='text-danger phoneNumberError'></small>
							</p>
							<p><input type="text" name="consultant_mobile_number" placeholder="Mobile*"
									value="<?php echo set_value('consultant_mobile_number'); ?>"
									oninput="this.className = ''" />
							...
							<p><select name="consultant_technology" id="consultant_technology"
									placeholder="Select Primary Skills*" oninput="this.className = ''">
							...
							<p><input type="text" name="consultant_other_skills" placeholder="Other Skills*"
									value="<?php echo set_value('consultant_other_skills'); ?>"
									oninput="this.className = ''" />
								<?php echo form_error('consultant_other_skills', "<small class='text-danger'>", "</small>"); ?>
							</p>
							<p><input type="text" name="consultant_reference" placeholder="Reference"
									value="<?php echo set_value('consultant_reference'); ?>" />
								<?php echo form_error('consultant_reference', "<small class='text-danger'>", "</small>"); ?>
							</p>
						</div>
						<div class="tab">
							<h2 class="fs-title">Address Details</h2>
							<p><input type="text" name="consultant_current_address1" placeholder="1234 Main St*"
									value="<?php echo set_value('consultant_current_address1'); ?>"
									oninput="this.className = ''" />
								<?php echo form_error('consultant_current_address1', "<small class='text-danger'>", "</small>"); ?>
							</p>
							<p><input type="text" name="consultant_current_address2"
									value="<?php echo set_value('consultant_current_address2'); ?>"
									placeholder="Apartment, studio, or floor*" oninput="this.className = ''" />
								<?php echo form_error('consultant_current_address2', "<small class='text-danger'>", "</small>"); ?>
							</p>
							<p><input type="text" name="consultant_current_address3" placeholder="Address*"
									value="<?php echo set_value('consultant_current_address3'); ?>"
									oninput="this.className = ''" />
								<?php echo form_error('consultant_current_address3', "<small class='text-danger'>", "</small>"); ?>
							</p>
							<p><input type="text" name="consultant_current_city" placeholder="City*"
									value="<?php echo set_value('consultant_current_city'); ?>"
									oninput="this.className = ''" />
								<?php echo form_error('consultant_current_city', "<small class='text-danger'>", "</small>"); ?>
							</p>
							<p><input type="text" name="consultant_current_state" placeholder="State*"
									value="<?php echo set_value('consultant_current_state'); ?>"
									oninput="this.className = ''" />
								<?php echo form_error('consultant_current_state', "<small class='text-danger'>", "</small>"); ?>
							</p>
							<p><input type="text" name="consultant_current_country" placeholder="Country*"
									value="<?php echo set_value('consultant_current_country'); ?>"
									oninput="this.className = ''" />
								<?php echo form_error('consultant_current_country', "<small class='text-danger'>", "</small>"); ?>
							</p>
							<p><input type="text" name="consultant_pincode" placeholder="Pin Code*"
									value="<?php echo set_value('consultant_pincode'); ?>" oninput="this.className = ''" />
								<?php echo form_error('consultant_pincode', "<small class='text-danger'>", "</small>"); ?>
								<small class='text-danger pincodeError'></small>
							</p>
							<p>
								<textarea name="consultant_alternative_address" placeholder=" Alternative Address"
									value="<?php echo set_value('consultant_alternative_address'); ?>"></textarea>
						...
						<div class="tab">
							...
							<p>
								<input type="file" name="resumeupload" accept=".doc,.docx,.pdf"
									onchange="validateFileSize(this)" value="<?php echo set_value('resumeupload'); ?>"
									oninput="this.className = ''" />
							...
							<p>
								<input type="file" name="pictureupload" accept=".jpg,.jpeg,.png"
									onchange="validateFileSize(this)" value="<?php echo set_value('pictureupload'); ?>"
									oninput="this.className = ''" />
							...
							<p>
								<input type="file" name="pancard" accept=".doc,.docx,.pdf,.jpg,.jpeg,.png"
									onchange="validateFileSize(this)" value="<?php echo set_value('pancard'); ?>"
									oninput="this.className = ''" />
							...
							<p>
								<input type="file" name="aadharcard" accept=".doc,.docx,.pdf,.jpg,.jpeg,.png"
									onchange="validateFileSize(this)" value="<?php echo set_value('aadharcard'); ?>"
									oninput="this.className = ''" />
							...
							<h6><strong>Note:</strong> Bank Statement (or) Cheque Leaf (or) Bank Pass book with clear
								mention of Bank name; Account holder name; Account number and IFSC code</h6>
							<p>
								<input type="file" name="bank_statement" accept=".doc,.docx,.pdf,.jpg,.jpeg,.png"
									onchange="validateFileSize(this)" value="<?php echo set_value('bank_statement'); ?>"
									oninput="this.className = ''" />
							...
							<p>
								<input type="file" name="nda_document" accept=".doc,.docx,.pdf,.jpg,.jpeg,.png"
									onchange="validateFileSize(this)" value="<?php echo set_value('nda_document'); ?>"
									oninput="this.className = ''" />
						...
						<div class="tab submitTab">
							...
							<p><input type="text" name="consultant_pan_number" placeholder="PAN Number*"
									value="<?php echo set_value('consultant_pan_number'); ?>"
									oninput="this.className = ''" />
								<?php echo form_error('consultant_pan_number', "<small class='text-danger'>", "</small>"); ?>
							</p>
							<p><input type="text" name="consultant_bank_name" placeholder="Bank Name*"
									value="<?php echo set_value('consultant_bank_name'); ?>"
									oninput="this.className = ''" />
								<?php echo form_error('consultant_bank_name', "<small class='text-danger'>", "</small>"); ?>
							</p>
							<p><input type="text" name="consultant_bank_account_number" placeholder="Bank Account Number*"
									value="<?php echo set_value('consultant_bank_account_number'); ?>"
									oninput="this.className = ''" />
							...
							<p><input type="text" name="consultant_bank_ifsc_code" placeholder="IFSC Code*"
									value="<?php echo set_value('consultant_bank_ifsc_code'); ?>"
									oninput="this.className = ''" />
								<?php echo form_error('consultant_bank_ifsc_code', "<small class='text-danger'>", "</small>"); ?>
							</p>
							<p><input type="text" name="consultant_alternative_bank_name"
									value="<?php echo set_value('consultant_alternative_bank_name'); ?>"
									placeholder="Alternative Bank Name" />
								<?php echo form_error('consultant_alternative_bank_name', "<small class='text-danger'>", "</small>"); ?>
							</p>
							<p><input type="text" name="consultant_alternative_bank_account_number"
									value="<?php echo set_value('consultant_alternative_bank_account_number'); ?>"
							...
							<p><input type="text" name="consultant_alternative_bank_ifsc_code" placeholder="IFSC Code"
									value="<?php echo set_value('consultant_alternative_bank_ifsc_code'); ?>" />
								<?php echo form_error('consultant_alternative_bank_ifsc_code', "<small class='text-danger'>", "</small>"); ?>
							</p>
							<p>
								<input type="checkbox" name="terms" />Check here to indicate that you have read and agree to
								the terms of the <a href="#" data-toggle="modal" data-target="#t_and_c_m">CG-VAK Consultant
									Agreement</a>
							</p>
						</div>
				...
				if (currentTab === 2) {
					if (y[i].value === "") {
						...
						if (y[i].name === "pictureupload") {
							...
							var position_of_dot = y[i].value.lastIndexOf('.') + 1;
							var validExt = ['pdf', 'jpg', 'jpeg', 'png', 'doc', 'docx'];

							var img_ext = y[i].value.substring(position_of_dot);
							var validaionResult = validExt.includes(img_ext);

							if (!validaionResult) {
								jQuery('.' + y[i].name + 'Error').text('Please upload a valid Image / Document [allowed formats - jpg, jpeg, png, pdf,doc,docx]');
								y[i].className += " invalid";
								valid = false;
							} else {
